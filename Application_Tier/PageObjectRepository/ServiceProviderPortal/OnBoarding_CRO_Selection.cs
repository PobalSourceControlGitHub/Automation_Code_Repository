...
{
    class OnBoarding_CRO_Selection_And_ChangeOfCircumstances_Scenarios
    {
        ...
        public OnBoarding_CRO_Selection_And_ChangeOfCircumstances_Scenarios(IWebDriver webDriver)
        {
        ...
        [TestMethod]
        public void StartOnboarding_Frontend_CRO(IWebDriver webDriver)
        {
            try
            {
